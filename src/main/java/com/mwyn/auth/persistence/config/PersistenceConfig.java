package com.mwyn.auth.persistence.config;
...
public class PersistenceConfig {
    ...
    private String getClassName() {
        return DynamicPropertyFactory.getInstance()
                .getStringProperty(DATASOURCE_CLASS_NAME, "org.postgresql.ds.PGSimpleDataSource").getValue();
    }
    ...
    private int getPortNumber() {
        return DynamicPropertyFactory.getInstance().getIntProperty(DATASOURCE_PORT, 15432).getValue();
    }

    private String getDatabaseName() {
        return DynamicPropertyFactory.getInstance()
                .getStringProperty(DATASOURCE_DB_NAME, "cashindb").getValue();
    }
    ...
    private String getUsername() {
        return DynamicPropertyFactory.getInstance().getStringProperty(DATASOURCE_USERNAME, "mwyn").getValue();
    }

    private String getPassword() {
        return DynamicPropertyFactory.getInstance().getStringProperty(DATASOURCE_PASSWORD, "nywm").getValue();
    }

    private String getDialect() {
        return DynamicPropertyFactory.getInstance()
                .getStringProperty(DIALECT, "org.hibernate.dialect.PostgreSQLDialect").getValue();
    }
    ...
    public LocalSessionFactoryBean sessionFactoryBean(@Qualifier("oauthDataSource") DataSource dataSource) {
        ...
        mwynAuthSessionFactory.setPackagesToScan("com.mwyn.auth");
